<template>
    ...
    <div class="form-with-guide--main-part__left--bottom"  >
      ...
      <el-form :model="form" label-width="30%" ref="formdata" style="padding:3rem;">
        <h3 class="form-with-guide--main-part__left--title u-font-f2f2f2">{{ $t('modelEvaluate.title') }}</h3>
        <div class="uploadButton" style="grid-template-columns: repeat(3,33%);">
          <!-- <div style="width: 15%"></div> -->
          
            <div class="single-card-two-button">
              <p>{{ $t('modelEvaluate.card_title_0') }}</p>
            ...
            :on-change="codeFileChange" :on-remove="codeFileRemove">
                <template #trigger>
                  <span class="single-card-two-button--button__left btn">{{ $t('modelEvaluate.button_0') }}</span>
                </template>
                <span class="single-card-two-button--button__right btn">{{ $t('modelEvaluate.button_1') }}</span>
              </el-upload>
            </div>
            
              <!-- <el-card shadow="hover">上传模型源码</el-card> -->
              <div class="single-card-two-button">
              <p>{{ $t('modelEvaluate.card_title_1') }}</p>
              <div class="single-card-two-button--icon-box">
            ...
            <!-- <div class="single-card-two-button">
              <p>{{ $t('modelEvaluate.card_title_2') }}</p>
              <div class="single-card-two-button--icon-box">
            ...
            <div class="single-card-two-button">
              <p>{{ $t('modelEvaluate.card_title_3') }}</p>
              <div class="single-card-two-button--icon-box">
