export function LeNet() {
    ...
    ///////    Methods    ///////
    /////////////////////////////////////////////////////////////////////////////
    console.log('svg', svg, 'lenet', lenet)
    ...
    function redraw({
        ...
        lenet.convs = architecture.map((layer, layer_index) => Object.assign({ 'id': 'conv_' + layer_index, 'layer': layer_index }, layer));
        lenet.convs.pop();
